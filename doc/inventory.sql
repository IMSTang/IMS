...
insert into sys_menu values('440',   'Sales Return', '400', '4', '/inventory/salesReturn',        'C', '0', 'inventory:salesReturn:view',         '#', 'admin', '2018-03-01', 'admin', '2018-03-01', 'resell Stock');
